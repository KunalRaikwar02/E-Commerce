  ...
  return (
    <section className="mt-24 sm:mt-32 md:mt-40 px-1 sm:px-2 md:px-4 mb-20">
      ...
      <div className="text-center">
        <p className="text-xs sm:text-sm text-gray-400 font-bold">[ follow us ]</p>
      ...
      <div className="mt-8 flex justify-center">
        <div
          ...
          className="inline-flex items-center gap-3 sm:gap-4 bg-[#581a90] px-3 sm:px-4 py-1.5 sm:py-2 rounded-sm cursor-pointer hover:bg-purple-800 transition"
        >
          <span className="text-white text-xs sm:text-sm font-semibold tracking-wide uppercase">VELTORNCLOTHES</span>
