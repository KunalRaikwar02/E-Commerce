...
// //       <nav data-cursor="white" className="w-full fixed top-[30px] left-0 z-50 px-4 sm:px-6 md:px-10">
...
// //             {/* SEARCH */}
// //             <div className="relative">
// //               <Search size={20} className="cursor-pointer hover:text-purple-400" onClick={() => setSearchOpen(!searchOpen)} />
// //               {searchOpen && (
// //                 <div className="absolute right-0 top-14 w-[90vw] sm:w-80 md:w-96 bg-black border border-gray-800 rounded-2xl shadow-2xl p-4 sm:p-6 space-y-5">
// //                   <div className="flex items-center gap-3 border border-gray-700 rounded-xl px-4 py-3 bg-[#0a0a0a] focus-within:border-white transition">
// //                     <Search size={18} className="text-gray-400" />
...
// //                     <div className="space-y-2 text-sm">
// //                       <p className="text-gray-500 text-xs uppercase font-bold tracking-tighter">Trending</p>
// //                       {trendingItems.map((item) => (
// //                         <p key={item} onClick={() => handleSuggestionClick(item)} className="hover:text-purple-400 cursor-pointer transition-colors">{item}</p>
// //                       ))}
// //                     </div>
// //                   )}
// //                 </div>
...
// //                 <div className="absolute right-0 top-14 w-56 bg-black border border-gray-800 rounded-2xl shadow-xl p-4 space-y-3">
...
//             {/* SEARCH */}
//             <div className="relative">
//               <Search size={20} className="cursor-pointer hover:text-purple-400" onClick={() => { setSearchOpen(!searchOpen); setTimeout(() => inputRef.current?.focus(), 100); }} />
//               {searchOpen && (
...
//               </div>
//               {activeMenu === "account" && isLoggedIn && (
//                 <div className="absolute right-0 top-12 w-56 bg-black border border-gray-800 rounded-2xl shadow-xl p-4 space-y-2 z-50">
//                   <div className="pb-3 border-b border-gray-800">
//                     <p className="text-xs font-black uppercase text-white truncate">{user?.name}</p>
//                     <p className="text-[10px] text-gray-500 truncate mt-0.5">{user?.email}</p>
//                   </div>
