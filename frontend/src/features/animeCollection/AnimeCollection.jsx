...
const AnimeCollection = () => {
  ...
  const animeCategories = [
    { id: 1, name: "NARUTO / NARUTO SHIPPUDEN", items: "12 ITEMS", img: "/assets/images/tshirt2.jpeg" },
    { id: 2, name: "SOLO LEVELING", items: "12 ITEMS", img: "/assets/images/tshirt4.jpeg" },
    { id: 3, name: "DEMON SLAYER", items: "12 ITEMS", img: "/assets/images/tshirt5.jpeg" },
    { id: 4, name: "ONE PIECE", items: "12 ITEMS", img: "/assets/images/tshirt3.jpeg" },
  ];
    ...
    <div className="min-h-screen bg-white mt-8 overflow-x-hidden">
      ...
      <div className="px-4 md:px-6 lg:px-10 mt-16">
        <div className="flex justify-between items-center mb-3 py-4">
          ...
          <button className="group bg-[#581a90] text-white px-5 py-2.5 rounded-md flex items-center gap-2 text-[10px] md:text-xs font-bold tracking-[2px] hover:bg-purple-800 transition-all shrink-0 uppercase">
      ...
      <div className="px-4 md:px-6 lg:px-10 mt-26">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {animeCategories.map((cat, index) => (
            <CategoryCard key={cat.id} cat={cat} isNew={index === 0} />
          ))}
        </div>
      </div>
