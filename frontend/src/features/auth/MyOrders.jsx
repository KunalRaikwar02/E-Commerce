...
export default function MyOrders() {
  ...
  return (
    <div className="min-h-screen bg-white pt-28 pb-20 px-4 md:px-12 mt-4">
      {/* Back → goes to HOME, not back in history */}
      <button
        onClick={() => navigate("/")}
        className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-black transition mb-6 cursor-pointer"
      >
