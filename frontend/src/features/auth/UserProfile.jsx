...
import { Camera, User, MapPin, Phone, Mail, ChevronRight, Package, LogOut, ArrowLeft, Save, CheckCircle, X } from "lucide-react";
        ...
        <div className="bg-white rounded-3xl p-7 border border-gray-100 shadow-sm flex items-center gap-5">
          ...
          {avatarPreview && (
            <button
              ...
              title="Remove photo"
              className="shrink-0 w-8 h-8 bg-red-50 text-red-400 hover:bg-red-100 hover:text-red-600 rounded-full flex items-center justify-center border border-red-100 transition cursor-pointer"
            >
              <X size={14} />
            </button>
          )}
