  ...
  return (
    <section className="mt-24 sm:mt-32 md:mt-45 px-4 sm:px-6 md:px-10">
      ...
      <div className="mt-8 flex justify-center">
        <div className="inline-flex items-center gap-3 sm:gap-4 bg-black px-3 sm:px-4 py-1.5 sm:py-2 rounded-sm cursor-pointer hover:bg-gray-900 transition">
        ...
        <div className="overflow-x-auto scrollbar-hide w-full">
          <div className="flex gap-6 sm:gap-8 w-max px-4 sm:px-6 items-center">
            ...
            <img
              ...
              alt="moment1"
              className="w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 object-cover rounded-full shrink-0"
            />
            ...
            <img
              ...
              alt="moment2"
              className="w-28 h-40 sm:w-36 sm:h-48 md:w-44 md:h-56 object-cover rounded-lg shrink-0"
            />
            ...
            <img
              ...
              alt="moment3"
              className="w-28 h-40 sm:w-36 sm:h-48 md:w-44 md:h-56 object-cover rounded-3xl shrink-0"
            />
